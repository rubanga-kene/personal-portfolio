...
const academicAchievements = [
  ...
  },
  {
    ...
    company: "Kyambogo College School",
    period: "2019 - 2020",
    description:
      "Offered Physics, Mathematics and Chemistry with ICT.",
  },
  {
          ...
          >
            <div className="relative overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 p-6 transition-all duration-300 hover:border-purple-500/50">
              ...
              <div className="relative">
                <h3 className="text-xl font-bold">{academicAchievement.title}</h3>
                <div className="text-zinc-400 mb-4">
                  {academicAchievement.company} | {academicAchievement.period}
                </div>
                <p className="text-zinc-300">{academicAchievement.description}</p>
              </div>
            </div>
          </motion.div>
